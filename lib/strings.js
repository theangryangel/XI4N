...
exports._chunkToUTF8 = function(str, from)
{
	...
	for(var i = 0, j = 0; i < str.length; i++)
	{
		...
		console.log('replacement for i = %d', replacement);
		...
		if (!!(replacement >> 8))
		{
			...
			buf.writeUInt16LE(replacement, j++);
			continue;
		}

		// single byte
		//buf[j++] = replacement;
		buf.writeUInt8(replacement, j++);
	}
