...
exports.IS_Abstract.prototype.postUnpack = function(buf)
{
	// noop by default
	// cheating workaround until I change how I export this file and can more
	// easily call the parent
}

exports.IS_Abstract.prototype.trimNonPrintables = function(str)
{
...
exports.IS_STA.prototype.postUnpack = function(buf)
{
	this.track = this.trimNonPrintables(this.track);
}
