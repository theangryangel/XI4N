...
try
{
	// Add's coffee-script support. 
	// coffee-script adds it's own handler for require()'ing coffeescript files
	require("coffee-script");
}
catch(err)
{
	// coffee-script support unavailable.
	// TODO: do we want to send a warning?
}
...
var ClientManager = function(options, basepath)
{
	...
	self.loadPlugins = function(plugins)
	{
		for (var i in plugins)
		{
			...
			// TODO: replace this with a decent pluginmanager.
			// TODO: Add a temporary fix to add coffee-script support - should it just be require() wrapped in try catch statements?
